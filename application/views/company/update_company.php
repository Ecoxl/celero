     	...
     	<div class="col-md-8">
			<div class="form-group">
 			...
 			<div class="form-group">
	    		...
	    		<div class="row">
		    		<div class="col-md-12">
		    			<input type="text" class="form-control" placeholder="NACE Code" id="naceCode" name="naceCode" style="color:#333333;" value="<?php echo set_value('naceCode',$nace_code['code']); ?>" readonly/>
		    		</div>
		    	</div>
		...
		<div class="modal-dialog">
		    <div class="modal-content">
			    ...
			    <div class="modal-body">
			      	<?php echo $map['html']; ?>
			      	<br>
			      	<button type="button" onclick="getCountryIdName();" data-dismiss="modal" class="btn btn-info btn-block" aria-hidden="true"><?php echo lang("done"); ?></button>
			    </div>
