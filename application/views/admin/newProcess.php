            ...
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR) {
                  ...
                  if(data["found"]==true) {
                      ...
                      if(data["id"]>0) {
                          noty({text: '<?php echo lang("notyprocessinserted"); ?>', type: 'success'});
                          $('#tt_tree_process').tree('reload');
                      } else {
                          noty({text: '<?php echo lang("notyprocessinsertedbefore"); ?>', type: 'warning'});
                          $('#tt_tree_process').tree('reload');
                      }
                  } else if(data["found"]==false) {         
                      //$.messager.alert('Insert failed','Failed to insert Flow Family !','error');
                      noty({text: '<?php echo lang("notyprocessnotinserted"); ?>', type: 'error'});  
                      $('#tt_tree_process').tree('reload');
                  }   
                },
		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('admin/newProcess'); ?>"><?php echo lang("processlink"); ?></a>
					</li>
				</ul>
			</div>
                        ...
                        <div class="row-fluid sortable">
                            <div class="box span12">
                                    <div class="box-header well" data-original-title>
                                            <h2><i class="icon-th"></i><?php echo lang("insertprocessfamily"); ?> </h2>
                                            <div class="box-icon">
                                    ...
                                    <div class="box-content">
                                        <div class="row-fluid">
                                            <div class="span4">
                                                <div class="easyui-panel" title="<?php echo lang("processfamily"); ?>" style="width:400px;height:auto;" data-options="">
						  ...
						  <fieldset>
							<legend><?php echo lang("insertprocessfamily"); ?></legend>
							<div class="control-group">
							  <label class="control-label" for="typeahead"><?php echo lang("processfamily"); ?></label>
							  <div class="controls">
							...
							<div class="form-actions">
							  <button type="submit" onclick='event.preventDefault();submitFormProcessFamily();' class="btn btn-primary"><?php echo lang("savedata"); ?></button>
