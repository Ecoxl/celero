    ...
    function deleteEditView(report_name, report_id) {
         ...
         $.ajax({
                ...
                success: function(data, textStatus, jqXHR) {
                             ...
                             noty({text: '<?php echo lang("notyclusterdeleted"); ?>', type: 'success'});
    ...
    function updateReport() {
        ...
        $('#ff').form({
            ...
            success:function(data){
                noty({text: '<?php echo lang("notyclusterupdated"); ?>', type: 'success'});
                         $('#tt_grid').datagrid('reload');
                         $.messager.progress('close');
     ...
     function saveReport() {
            ...
            $('#ff').form({
                ...
                success:function(data){
                             ...
                             noty({text: '<?php echo lang("notyclusterinserted"); ?>', type: 'success'});
                             $('#tt_grid').datagrid('reload');
                             $.messager.progress('close');
                ...
                success: function(data, textStatus, jqXHR) {
                  ...
                  if(data["found"]==true) {
                      ...
                      if(data["id"]>0) {
                          ...
                          noty({text: '<?php echo lang("notyclusterinsertedbefore"); ?>', type: 'warning'});
                          $('#tt_tree').tree('reload');
                      }
                      
                  } else if(data["found"]==false) {         
                      //$.messager.alert('Insert failed','Failed to insert Flow Family !','error');
                      noty({text: '<?php echo lang("notyclusternotinserted"); ?>', type: 'error'});  
                  }   
                },
            ...
            columns:[[
                ...
                {field:'edit',title:'<?php echo lang("edit"); ?>',width:50,align:'center',
                    formatter:function(value,row,index){
                        ...
                        var x = '<a href="" class="easyui-linkbutton" \n\
                                    iconCls="icon-save" \n\
                                    onclick="reportEditView(\''+row.cluster_name+'\','+row.id+', \''+row.industrial_zone_name+'\', '+row.industrial_zone_id+' );event.preventDefault();"><?php echo lang("edit"); ?> </a>';
                        //return e+d;
                        return x;
                ...
                {field:'delete',title:'<?php echo lang("delete"); ?>',width:50,align:'center',
                    formatter:function(value,row,index){
                        ...
                        var x = '<a href="" class="easyui-linkbutton" \n\
                                    iconCls="icon-save" \n\
                                    onclick="deleteEditView(\''+row.cluster_name+'\','+row.id+', \''+row.industrial_zone_name+'\', '+row.industrial_zone_id+' );event.preventDefault();"><?php echo lang("delete"); ?> </a>';
                        //return e+d;
                        return x;
		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('admin/clusters'); ?>"><?php echo lang("clusterslink"); ?></a>
					</li>
				</ul>
			</div>
			...
			<div class="sortable row-fluid">
				...
				<a data-rel="tooltip" title="" class="well span3 top-block" href="#">
					...
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i><?php echo lang("insertcluster"); ?> </h2>
						<div class="box-icon">
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<!--<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>-->
						</div>
                                        ...
                                        <div class="box-content" style='padding: 0px;'>
                                                <div id="p2" class="easyui-panel" style="height:250px;" title="<?php echo lang("clusterinfo"); ?>" 
                                                      ...
                                                      <form id="ff" method="post">
                                                        <div style="padding:10px 60px 20px 60px">
                                                            <div style="margin-bottom: 4px;margin-left: -8px;">
                                                                <label style="margin-right:18px;"><?php echo lang("cluster"); ?>:</label>
                        ...
                        <div class="row-fluid sortable">
                            <div class="box span12">
                                    <div class="box-header well" data-original-title>
                                            <h2><i class="icon-th"></i><?php echo lang("clusterslink"); ?> </h2>
                                            <div class="box-icon">
                                        ...
                                        <div class="row-fluid" >
                                            ...
                                            <div class="span12">
                                                <div id="p2" class="easyui-panel"  
                                                     title="<?php echo lang("clusterslink"); ?>" 
