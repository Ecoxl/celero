...
<?php  $allocation = array_merge($allocation, $is);  //print_r($allocation); ?>
    ...
    <table class="tg costtable">
        <tr>
            <th class="title_cb_th" colspan="9" style="font-size: 12px; text-align: left;">Baseline:
            <?php if(empty($a['cmpny_from_name'])) {echo $a['best'];} else {echo $a['flow_name']." input IS potential from/to ".$a['cmpny_from_name']; } ?></th>
            <th class="title_cb_th" colspan="19" style="font-size: 12px; border-left:2px solid grey; text-align: left;">Option</th>
        </tr>
        <tr>
            ...
            <th class="th-yw4l" bgcolor="#fefefc">EP <button id="prefix<?php echo $i;?>" type="button"
             class="btn btn-default btn-sm"> pts</button></th>
			...
			<?php foreach ($allocation as $a): ?>
				...
				/*	$('#form-<?php echo $i; ?> input').keydown(function(e){
					...
					function calculate(){
                        ...
                        //flow eip-1
                        $("#flow-eip-1-<?php echo $i; ?>").val(($("#flow-eipunit-1-<?php echo $i; ?>").val()*$("#flow-value-1-<?php echo $i; ?>").val()*factor).toFixed(4));
                        //flow eip-2
                        $("#flow-eip-1-2-<?php echo $i; ?>").val(($("#flow-eipunit-1-2-<?php echo $i; ?>").val()*$("#flow-value-1-2-<?php echo $i; ?>").val()*factor).toFixed(4));
                        //flow eip-3
                        $("#flow-eip-1-3-<?php echo $i; ?>").val(($("#flow-eipunit-1-3-<?php echo $i; ?>").val()*$("#flow-value-1-3-<?php echo $i; ?>").val()*factor).toFixed(4));
                        //flow eip-4
                        $("#flow-eip-1-4-<?php echo $i; ?>").val(($("#flow-eipunit-1-4-<?php echo $i; ?>").val()*$("#flow-value-1-4-<?php echo $i; ?>").val()*factor).toFixed(4));
                        //flow eip-5
                        $("#flow-eip-1-5-<?php echo $i; ?>").val(($("#flow-eipunit-1-5-<?php echo $i; ?>").val()*$("#flow-value-1-5-<?php echo $i; ?>").val()*factor).toFixed(4));
                        //flow eip-6
                        $("#flow-eip-1-6-<?php echo $i; ?>").val(($("#flow-eipunit-1-6-<?php echo $i; ?>").val()*$("#flow-value-1-6-<?php echo $i; ?>").val()*factor).toFixed(4));
                        ...
                        //flow eip-2
                        $("#flow-eip-2-<?php echo $i; ?>").val(($("#flow-eipunit-2-<?php echo $i; ?>").val()*$("#flow-value-2-<?php echo $i; ?>").val()*factor).toFixed(4));
                        //flow eip-2-2
                        $("#flow-eip-2-2-<?php echo $i; ?>").val(($("#flow-eipunit-2-2-<?php echo $i; ?>").val()*$("#flow-value-2-2-<?php echo $i; ?>").val()*factor).toFixed(4));
                        //flow eip-2-3
                        $("#flow-eip-2-3-<?php echo $i; ?>").val(($("#flow-eipunit-2-3-<?php echo $i; ?>").val()*$("#flow-value-2-3-<?php echo $i; ?>").val()*factor).toFixed(4));
                        //flow eip-2-4
                        $("#flow-eip-2-4-<?php echo $i; ?>").val(($("#flow-eipunit-2-4-<?php echo $i; ?>").val()*$("#flow-value-2-4-<?php echo $i; ?>").val()*factor).toFixed(4));
                        //flow eip-2-5
                        $("#flow-eip-2-5-<?php echo $i; ?>").val(($("#flow-eipunit-2-5-<?php echo $i; ?>").val()*$("#flow-value-2-5-<?php echo $i; ?>").val()*factor).toFixed(4));
                        //flow eip-2-6
                        $("#flow-eip-2-6-<?php echo $i; ?>").val(($("#flow-eipunit-2-6-<?php echo $i; ?>").val()*$("#flow-value-2-6-<?php echo $i; ?>").val()*factor).toFixed(4));
                        ...
                        //opex_dif-1
                        $("#ecoben-eip-1-<?php echo $i; ?>").val(parseInt($("#flow-eip-1-<?php echo $i; ?>").val())-parseInt($("#flow-eip-2-<?php echo $i; ?>").val())*factor);
                        //opex_dif-2
                        $("#ecoben-eip-1-2-<?php echo $i; ?>").val(parseInt($("#flow-eip-1-2-<?php echo $i; ?>").val())-parseInt($("#flow-eip-2-2-<?php echo $i; ?>").val())*factor);
                        //opex_dif-3
                        $("#ecoben-eip-1-3-<?php echo $i; ?>").val(parseInt($("#flow-eip-1-3-<?php echo $i; ?>").val())-parseInt($("#flow-eip-2-3-<?php echo $i; ?>").val())*factor);                        
                        //opex_dif-4
                        $("#ecoben-eip-1-4-<?php echo $i; ?>").val(parseInt($("#flow-eip-1-4-<?php echo $i; ?>").val())-parseInt($("#flow-eip-2-4-<?php echo $i; ?>").val())*factor);                        
                        //opex_dif-5
                        $("#ecoben-eip-1-5-<?php echo $i; ?>").val(parseInt($("#flow-eip-1-5-<?php echo $i; ?>").val())-parseInt($("#flow-eip-2-5-<?php echo $i; ?>").val())*factor);                        
                        //opex_dif-6
                        $("#ecoben-eip-1-6-<?php echo $i; ?>").val(parseInt($("#flow-eip-1-6-<?php echo $i; ?>").val())-parseInt($("#flow-eip-2-6-<?php echo $i; ?>").val())*factor);
                    ...
                    index<?php echo $i ?> = 0;
                    factor = 1;
                    $("#prefix<?php echo $i ?>").click(function () {
                        if (index<?php echo $i ?> > 3) {
                            index<?php echo $i ?> = 0;
                            factor = 1;
                        };
                        //console.log(index<?php echo $i ?>);
                        //calculates and formats the kilo, Mega and Giga values
                        switch (index<?php echo $i ?>) {
                            case 0:
                                factor = 0.001;
                                console.log("case0");
                                $("#prefix<?php echo $i ?>").html("kilo pts");
                                $('#form-<?php echo $i; ?> th').eq('19').text("EP kilo pts");
                                $('#form-<?php echo $i; ?> th').eq('26').text("Ecological Benefit (EP) kilo pts");
                                $('#form-<?php echo $i; ?> #flow-eip-1-<?php echo $i; ?>').trigger("change", calculate);
                                break;
                            case 1:
                                factor = 0.000001;
                                console.log("case1");
                                $("#prefix<?php echo $i ?>").html("Mega pts");
                                $('#form-<?php echo $i; ?> th').eq('19').text("EP Mega pts");
                                $('#form-<?php echo $i; ?> th').eq('26').text("Ecological Benefit (EP) Mega pts");
                                $('#form-<?php echo $i; ?> #flow-eip-1-<?php echo $i; ?>').trigger("change", calculate);
                                break;
                            case 2:
                                factor = 0.000000001;
                                console.log("case2");
                                $("#prefix<?php echo $i ?>").html("Giga pts");
                                $('#form-<?php echo $i; ?> th').eq('19').text("EP Giga pts");
                                $('#form-<?php echo $i; ?> th').eq('26').text("Ecological Benefit (EP) Giga pts");
                                $('#form-<?php echo $i; ?> #flow-eip-1-<?php echo $i; ?>').trigger("change", calculate);
                                break;
                            case 3:
                                factor = 1;
                                console.log("case3");
                                $("#prefix<?php echo $i ?>").html("pts");
                                $('#form-<?php echo $i; ?> th').eq('19').text("EP");
                                $('#form-<?php echo $i; ?> th').eq('26').text("Ecological Benefit (EP)");
                                $('#form-<?php echo $i; ?> #flow-eip-1-<?php echo $i; ?>').trigger("change", calculate);
                                break;
                            default:
                        };
