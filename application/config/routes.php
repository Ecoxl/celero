...
$route['addConsultantToProject/(:any)'] = "project/addConsultantToProject/$1";
...
$route['nis/(:any)'] = "company/isSelectionWithFlow/$1";
$route['nis'] = "company/isSelectionWithFlow";
...
// Dataset
$route['deleteuserep/(:any)/(:any)'] = "user/deleteUserEp/$1/$2";
$route['datasetexcel'] = "user/dataFromExcel";
$route['uploadExcel'] = "user/uploadExcel";
