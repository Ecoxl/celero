...
(function($) {
    ...
    var methods = {
            ...
            for (var i = 0; i < rules.length; i++) {
                ...
                switch (rules[i]) {
                    ...
                    case "min":
                        ...
                        break;
                    case "dropdownsec":
                        errorMsg = methods._dropdownsec(field, rules, i, options);
                        break;
                    case "max":
        ...
        /**
         * Check dropdown degeri kontrol value
         *
         * @param {jqObject} field
         * @param {Array[String]} rules
         * @param {int} i rules index
         ...
         * @return an error string if validation failed
         */
        _dropdownsec: function(field, rules, i, options) {
            var dropdownsec = parseFloat(rules[i + 1]);
            var len = parseFloat(field.val());

            if (len < dropdownsec) {
                var rule = options.allrules.dropdownsec;
                if (rule.alertText2) return rule.alertText + dropdownsec + rule.alertText2;
