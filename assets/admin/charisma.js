$(document).ready(function(){
	...
	{
		$('#bs-css').attr('href','http://88.249.18.205:8090/ecoman/assets/admin/css/bootstrap-'+theme_name+'.css');
	}
...
function docReady(){
	...
	//pie chart
	var data = [
	{ label: "Şube Giriş",  data: 12},
	{ label: "Erteleme",  data: 27},
	{ label: "Fatura Çıktısı",  data: 85},
	{ label: "Tanımsız Eşya",  data: 64},
	{ label: "Kayıp / Noksan",  data: 90},
	{ label: "Şube Çıkış",  data: 112}
	];
...
(function ($) { //an IIFE so safely alias jQuery to $
        $.Stack = function (element) { //renamed arg for readability
            ...
            if(this.element.length)
            {
                ...
                console.log(this.defaultOptions);
                    ...
                    for (var i = 0; i <= 10; i += 1)
                    //d1.push([i, parseInt(Math.random() * 30)]);
                        this.defaultOptions.d1.push([i, parseInt(Math.random() * 30)]);

                    //var d2 = [];
                    for (var i = 0; i <= 10; i += 1)
                            //d2.push([i, parseInt(Math.random() * 30)]);
                            this.defaultOptions.d2.push([i, parseInt(Math.random() * 30)]);

                    //var d3 = [];
                    for (var i = 0; i <= 10; i += 1)
                            //d3.push([i, parseInt(Math.random() * 30)]);
                            this.defaultOptions.d3.push([i, parseInt(Math.random() * 30)]);

                    //var stack = 0, bars = true, lines = false, steps = false;
                    this.stack =0, this.bars = true, this.lines = false, this.steps = false;
            }
        };
        ...
        $.Stack.prototype = {
			...
			plotWithOptions();
                ...
                plotWithOptions : function() {
                    $.plot($("#stackchart"), [ this.defaultOptions.d1, this.defaultOptions.d2, this.defaultOptions.d3 ], {
                            series: {
                                    stack: this.stack,
                                    lines: { show: this.lines, fill: true, steps: this.steps },
                                    bars: { show: this.bars, barWidth: 0.6 }
                            }
                    });
                },
                defaultOptions : {
