...
/** api: constructor
 *  .. class:: OstimMapContext(config)
 *
 *    Manages global map context loading/saving and notifying observers.
 */
Ostim.data.OstimMapContext = Ext.extend(Ext.util.Observable, {
    ...
    constructor: function (config) {
        //console.log('Ostim.data.OstimMapContext constructor()');
        ...
        Ostim.data.OstimMapContext.superclass.constructor.apply(this, arguments);
    },
    ...
    /** api: method[load]
    *  Load a Ostim Map Context (HMC) from a resource (filepath or URL).
        ...
        OpenLayers.Request.GET({
            ...
            callback: function (request) {
                ...
                if (self.async === true) {
                    ...
                    self.context = Ostim.data.MapContextParser.parse(responseXML, self);
...
//							iconCls: "hr-tree-node-icon-" + layerType,
    ...
    /*	addResolution : function(title, node) {
     ...
     Ostim.config.resolution.add(title, minResolution, maxResolution);
     },  */
