 ...
 */
Ostim.data.OWSCapabilitiesCache = Ext.extend(Ext.util.Observable, {
    ...
    constructor: function (options) {
        ...
        Ostim.data.OWSCapabilitiesCache.superclass.constructor.apply(this, arguments);
    },
...
// Singleton
Ostim.data.OWSCapabilitiesCache.getInstance = function () {
    var instance = Ostim.data.OWSCapabilitiesCacheInstance;
    if (!instance) {
        instance = Ostim.data.OWSCapabilitiesCacheInstance = new Ostim.data.OWSCapabilitiesCache();
    }
    return instance;
};