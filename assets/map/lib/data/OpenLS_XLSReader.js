...
Ostim.data.OpenLS_XLSReader = function(meta, recordType) {
	meta = meta || {};
	...
	Ostim.data.OpenLS_XLSReader.superclass.constructor.call(this, meta, recordType || meta.fields);
};

Ext.extend(Ostim.data.OpenLS_XLSReader, Ext.data.XmlReader, {
