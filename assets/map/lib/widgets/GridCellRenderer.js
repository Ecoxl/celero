 ...
 *
 */
Ostim.widgets.GridCellRenderer =
        ...
        (function () { // Creates and runs anonymous function, its result is assigned to Singleton
            ...
            var instance = {
                ...
                directLink: function (value, metaData, record, rowIndex, colIndex, store) {
                    ...
                    url = Ostim.widgets.GridCellRenderer.substituteAttrValues(url, options, record);
                ...
                browserPopupLink: function (value, metaData, record, rowIndex, colIndex, store) {
                    ...
                    var BrowserParam = '\'' + (options.winName ? options.winName : 'herongridcellpopup') + '\''
                                    ...
                                    + ', \'' + (Ostim.widgets.GridCellRenderer.substituteAttrValues(templateURL, options, record)) + '\''
                    ...
                    // <a href="#" onclick="Ostim.Utils.openBrowserWindow('demoWin', false, 'http://en.wikipedia.org/wiki/Germany', true, true, true, true, true, true, true, 10, 20, true, 600, 800); return false">Germany</a>
                    return (options.attrPreTxt ? options.attrPreTxt : "") + '<a href="#" onclick="' + 'Ostim.Utils.openBrowserWindow(' + BrowserParam + '); return false">' + value + '</a>';
                },
