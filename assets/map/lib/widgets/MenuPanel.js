 ...
 */
Ostim.widgets.MenuPanel = Ext.extend(
		Ext.Panel,
{
	/**
	...
	initComponent : function() {
		...
		this.addListener('afterrender', function() {
			if (this.hropts) {
				...
				Ostim.widgets.MenuHandler.init(this.hropts);
			}
		});
		Ostim.widgets.MenuPanel.superclass.initComponent.apply(this, arguments);
	}
});

/** api: xtype = hr_menupanel */
Ext.reg('hr_menupanel', Ostim.widgets.MenuPanel);
