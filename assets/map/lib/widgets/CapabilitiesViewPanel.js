 ...
 */
Ostim.widgets.CapabilitiesViewPanel = Ext.extend(Ext.tree.TreePanel, {
    ...
    initComponent: function () {
        ...
        Ostim.widgets.CapabilitiesViewPanel.superclass.initComponent.call(this);
    ...
    addLayers2Tree: function () {
        //for (var layer in Ostim.options.map.layers) {
        //layer = Ostim.options.map.layers[layer];
...
Ext.reg('hr_capabilitiesviewpanel', Ostim.widgets.CapabilitiesViewPanel);
