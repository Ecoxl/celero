...
/** api: example
 *  Sample code showing how to configure a Ostim LayerCombo.
 ...
 *
 */
Ostim.widgets.LayerCombo = Ext.extend(Ext.form.ComboBox, {
    ...
    initComponent: function () {
        ...
        Ostim.widgets.LayerCombo.superclass.initComponent.apply(this, arguments);
...
Ext.reg('hr_layercombo', Ostim.widgets.LayerCombo);
