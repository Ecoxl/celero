...
Ostim.widgets.GXP_LayerPanel_Empty = Ext.extend(Ext.Container, {});
 ...
 */
Ostim.widgets.GXP_LayerPanel = Ext.extend(Ext.Panel, {
...
// See also: http://ian01.geog.psu.edu/geoserver_docs/apps/gaz/search.html
    initComponent: function () {
      ...
      // private array of pending getLayerRecord requests
        ...
        Ostim.widgets.GXP_LayerPanel.superclass.initComponent.call(this);
    },
    ...
    createSourceLoader: function (key) {
        ...
        this.mapPanel = Ostim.App.getMapPanel();
...
Ext.reg('hr_gxplayerpanel', Ostim.widgets.GXP_LayerPanel);
