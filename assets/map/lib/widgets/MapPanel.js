...
Ostim.widgets.MapPanelOptsDefaults = {
    center: '0,0',
 ...
 */
Ostim.widgets.MapPanel = Ext.extend(
    GeoExt.MapPanel,
    {
        /** api: config[useMapContext]
         *  Use the Ostim Map Context (HMC) provided by Ostim.App. The HMC defines a Map settings and Layers. Default value is false.
         */
        useMapContext: false,
        ...
        initComponent: function () {
            ...
            Ext.apply(gxMapPanelOptions, Ostim.widgets.MapPanelOptsDefaults);

            // Special case: loading from a global MapContext
            if (this.useMapContext) {
                var context = Ostim.App.getMapContext(this.context);
            ...
            if (this.layers) {
                ...
                for (var i = 0; i < this.layers.length; i++) {
                    if (this.layers[i] instanceof Array) {
                        ...
                        try {
                            this.layers[i] = Ostim.Utils.createOLObject(this.layers[i]);
                        } catch (err) {
            ...
            Ostim.widgets.MapPanel.superclass.initComponent.call(this);
            ...
            Ostim.App.setMap(this.getMap());

            // Set the global GeoExt MapPanel variable, some need it
            Ostim.App.setMapPanel(this);

            // Build top toolbar (if specified)
            Ostim.widgets.ToolbarBuilder.build(this,
                this.hropts.toolbar,
                this.getTopToolbar());
        ...
        afterRender: function () {
            Ostim.widgets.MapPanel.superclass.afterRender.apply(this, arguments);
...
Ext.reg('hr_mappanel', Ostim.widgets.MapPanel);
