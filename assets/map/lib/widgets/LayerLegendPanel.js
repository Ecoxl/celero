 ...
 *
 */
Ostim.widgets.LayerLegendPanel = Ext.extend(GeoExt.LegendPanel, {
    title: __('Legend'),
    ...
    initComponent: function () {
        ...
        Ostim.widgets.LayerLegendPanel.superclass.initComponent.call(this);
    },
     ...
     */
    onRender: function () {
        Ostim.widgets.LayerLegendPanel.superclass.onRender.apply(this, arguments);
    ...
    addLegend: function (record, index) {
        ...
        // This is also the Ostim config convention for Layer
        ...
        if ((this.prefetchLegends && !legend) || (((layer.map && layer.visibility) || layer.getVisibility()) && !legend && !layerLegendMD.hideInLegend)) {
            ...
            Ostim.widgets.LayerLegendPanel.superclass.addLegend.apply(this, arguments);
    ...
    getLegendUrlFromCapabilities: function (serviceUrl, layerName, styleName) {
        ...
        var layerCaps = Ostim.data.OWSCapabilitiesCache.getInstance().getWMSLayerCapability(serviceUrl, layerName, {async: false});
        if (!layerCaps) {
...
Ext.reg('hr_layerlegendpanel', Ostim.widgets.LayerLegendPanel);
