 ...
 */
Ostim.widgets.LayerNodeContextMenu = Ext.extend(Ext.menu.Menu, {
    listeners: {
    ...
    initComponent: function () {
        ...
        Ostim.widgets.LayerNodeContextMenu.superclass.initComponent.call(this);
    }
});

/** api: xtype = hr_layernodecontextmenu */
Ext.reg('hr_layernodecontextmenu', Ostim.widgets.LayerNodeContextMenu);
