...
/** api: constructor
 *  .. class:: Ostim.widgets.IFramePanel(config)
 *
 *  A panel designed to hold URL content within an IFrame.
 */
Ostim.widgets.IFramePanel = Ext.extend(Ext.Panel, {
	name: 'iframe',
	iframe: null,
	...
	initComponent: function() {
		...
		Ostim.widgets.IFramePanel.superclass.initComponent.apply(this, arguments);
	...
	onRender : function() {
		Ostim.widgets.IFramePanel.superclass.onRender.apply(this, arguments);
...
Ext.reg('hr_iframePpanel', Ostim.widgets.IFramePanel);