...
// adapted for Ostim with general LayerCombo class, namespacing and I18N
// Ext.ns('GeoExt.ux');
 ...
 *  base_link = `Ostim.widgets.LayerCombo <LayerCombo.html>`_
 */
 ...
 *
 * @constructor
 * @extends Ostim.widgets.LayerCombo
 *
 */
Ostim.widgets.BaseLayerCombo = Ext.extend(Ostim.widgets.LayerCombo, {
	...
	initComponent: function () {
		...
		Ostim.widgets.BaseLayerCombo.superclass.initComponent.apply(this, arguments);
	}

});

/** api: xtype = hr_baselayer_combobox */
Ext.reg('hr_baselayer_combobox', Ostim.widgets.BaseLayerCombo);
