 ...
 */
Ostim.widgets.XMLTreePanel = Ext.extend(Ext.tree.TreePanel, {
			/**
			...
			initComponent : function() {
				...
				Ostim.widgets.XMLTreePanel.superclass.initComponent.apply(this, arguments);
...
Ext.reg('hr_xmltreepanel', Ostim.widgets.XMLTreePanel);
