...
Ostim.widgets.ActiveLayerNode = Ext.extend(GeoExt.tree.LayerNode, {
	...
	render: function(bulkRender) {
		...
		Ostim.widgets.ActiveLayerNode.superclass.renderX.call(this, bulkRender);
...
*/
Ext.tree.TreePanel.nodeTypes.hr_activelayer = Ostim.widgets.ActiveLayerNode;
 ...
 *
 */
Ostim.widgets.ActiveLayersPanel = Ext.extend(Ext.tree.TreePanel, {
	...
	initComponent : function() {
		...
		Ostim.widgets.ActiveLayersPanel.superclass.initComponent.call(this);
...
Ext.reg('hr_activelayerspanel', Ostim.widgets.ActiveLayersPanel);
