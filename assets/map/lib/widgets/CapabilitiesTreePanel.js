 ...
 */
Ostim.widgets.CapabilitiesTreePanel = Ext.extend(Ext.tree.TreePanel, {

	initComponent : function() {
		// Default WMS Layer object parameters, optional override with Ostim config
		...
		Ostim.widgets.CapabilitiesTreePanel.superclass.initComponent.call(this);
	}
});

/** api: xtype = hr_CapabilitiesTreePanel */
Ext.reg('hr_capabilitiestreepanel', Ostim.widgets.CapabilitiesTreePanel);
