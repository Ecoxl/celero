 ...
 *
 */
Ostim.widgets.search.ZeynelInfoPopup = Ext.extend(GeoExt.Popup, {
    ...
    initComponent: function () {
        ...
        //console.error(this);
        console.warn('ZeynelInfopopUp initcomponent');
        ...
        // Superclass init
        Ostim.widgets.search.ZeynelInfoPopup.superclass.initComponent.call(this);
    },
...
Ext.reg('hr_zeynelinfopopup', Ostim.widgets.search.ZeynelInfoPopup);
