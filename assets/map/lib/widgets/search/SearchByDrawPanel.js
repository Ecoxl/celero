 ...
 */
Ostim.widgets.search.SearchByDrawPanel = Ext.extend(Ostim.widgets.search.SpatialSearchPanel, {
...
// See also: http://ian01.geog.psu.edu/geoserver_docs/apps/gaz/search.html
    initComponent: function () {
        ...
        Ostim.widgets.search.SearchByDrawPanel.superclass.initComponent.call(this);
    ...
    onSearchComplete: function (searchPanel, result) {
        Ostim.widgets.search.SearchByFeaturePanel.superclass.onSearchComplete.call(this, searchPanel, result);
        this.cancelButton.disable();
    },
...
Ext.reg('hr_searchbydrawpanel', Ostim.widgets.search.SearchByDrawPanel);
