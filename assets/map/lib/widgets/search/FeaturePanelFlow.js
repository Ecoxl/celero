 ...
 */
Ostim.widgets.search.FeaturePanelFlow = Ext.extend(Ext.Panel, {
...
//	}),
    ...
    initComponent: function () {
        ...
        //console.log('featureGrid panel showGeometries() init');
        ...
        Ostim.widgets.search.FeaturePanelFlow.superclass.initComponent.call(this);
        ...
        this.tableGridFlow = new Ext.grid.GridPanel ({
            id: 'grd_Table'+ '_' + this.featureSetKey,
            store: this.storeFlow,
            //store: this.store,
            title: this.title,
            autoScroll: true,
        ...
        if (this.zoomOnRowDoubleClick) {
            ...
            this.tableGridFlow.on('celldblclick', function (grid, rowIndex, columnIndex, e) {
        ...
        if ((this.displayPanels.indexOf('Table')>=0) && (this.displayPanels.indexOf('Detail')>=0)) {
            ...
            this.tableGridFlow.on('cellclick', function (grid, rowIndex, columnIndex, e) {
                if (columnIndex == 0) {
        ...
        if (this.tableGridFlow)
            this.cardPanels.push(this.tableGridFlow);
        if (this.propGrid)
        ...
        if ((this.showTopToolbar) && (this.displayPanels.indexOf('Table')>=0) && (this.displayPanels.indexOf('Detail')>=0)) {
            ...
            this.tableGridFlow.addListener("activate", this.onActivateTable, this);
            ...
            this.tableGridFlow.addListener("afterlayout", this.onAfterlayoutTable, this);
                ...
                handler: function (btn) {
                    if (btn.pressed) {
                        ...
                        if  (btn.iconCls == 'icon-table') {
                            ...
                            selRecord = this.tableGridFlow.selModel.getSelected();
                            if (selRecord){
                                //var selIndex = this.tableGrid.store.indexOf(selRecord);
                                var selIndex = this.tableGridFlow.store.indexOf(selRecord);
    ...
    displayVertical: function (action, intRecNew) {
        ...
        var objCount = this.tableGridFlow.store ? this.tableGridFlow.store.getCount() : 0;
        var value;
        ...
        if (objCount > 0) {
            ...
            if (action != 'first'){
                ...
                this.tableGridFlow.selModel.selectRow(this.propGrid.curRecordNr, false);
            }
        }
    ...
    loadFeatures: function (features, featureType) {
        ...
        //this.storeFlow.loadData(features);
    ...
    hasFeatures: function () {
        ...
        //return this.store && this.storeFlow.getCount() > 0;
    },
    ...
    removeFeatures: function () {
        ...
        /*if (this.storeFlow) {
            this.storeFlow.removeAll(false);
        }*/
    ...
    setupStore: function (features) {
        ...
        /*if (this.storeFlow && !this.autoConfig) {
            return;
        }*/
        ...
        //this.storeFlow = new GeoExt.data.FeatureStore(storeConfig);
    },
...
Ext.reg('hr_featurepanelflow', Ostim.widgets.search.FeaturePanelFlow);

/** Old, compat with pre-1.0.1 name. */
Ext.reg('hr_featuregridpanelflow', Ostim.widgets.search.FeaturePanelFlow);

/** Old, compat with pre-0.72 name. */
Ext.reg('hr_featselgridpanelflow', Ostim.widgets.search.FeaturePanelFlow);