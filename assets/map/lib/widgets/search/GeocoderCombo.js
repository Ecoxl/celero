 ...
 */   
Ostim.widgets.search.GeocoderCombo = Ext.extend(Ext.form.ComboBox, {
	...
	/** Example: The example below uses plain WFS but needs a proxy
		...
		{
            ...
            // srs: "EPSG:31467",
            srs: Ostim.options.map.settings.projection,
            ...
            store: new Ext.data.Store({
          	...
          	proxy: new (Ext.extend(GeoExt.data.ProtocolProxy, {
	                    ...
	                    protocol: new OpenLayers.Protocol.WFS({
	                        ...
	                        url: Ostim.scratch.urls.WFS_ISD,
	                        featurePrefix: "isd-db",
	                        featureType: "db-org-rb",
	                        // srsName: "EPSG:31467",
                            srsName: Ostim.options.map.settings.projection,
	...
	*/
    ...
    initComponent: function() {
        ...
        return Ostim.widgets.search.GeocoderCombo.superclass.initComponent.apply(this, arguments);
    },
...
//            "click": this.removeLocationFeature,
        ...
        delete this.layer;
        delete this.center;
        Ostim.widgets.search.GeocoderCombo.superclass.beforeDestroy.apply(this, arguments);
    },
...
Ext.reg("hr_geocodercombo", Ostim.widgets.search.GeocoderCombo);
