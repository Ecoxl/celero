 ...
 *
 */
Ostim.widgets.search.FeatureInfoPanel = Ext.extend(Ext.Panel, {
    /** api: title
     *  ``String``
    ...
    initComponent: function () {
        ...
        Ostim.widgets.search.FeatureInfoPanel.superclass.initComponent.call(this);
        ...
        if (!this.olControl) {
            var controls = this.map.getControlsByClass("OpenLayers.Control.WMSGetFeatureInfo");
            //console.warn('WMSGetFeatureInfo control sayısı-->'+controls.length);
            console.warn('controls length featureInfoPanel-->'+controls.length);
    ...
    handleVectorFeatureInfo: function (evt) {
        ...
        console.warn('handleVectorFeatureInfo FeatureInfoPanel');
    ...
    getFeaturesByXY: function(x, y) {
        ...
        for (i=this.map.layers.length-1; i>=0; --i) {
            ...
            if (layer.div.style.display !== "none") {
                ...
                console.warn('layer instanceof OpenLayers sonrası featureinfoPanel');
                layers.push(layer);
    ...
    displayFeatureInfo: function (evt) {
        ...
        for (featureSetKey in featureSets) {
            ...
            var panel = new Ostim.widgets.search.FeaturePanel({
...
Ext.reg('hr_featureinfopanel', Ostim.widgets.search.FeatureInfoPanel);
