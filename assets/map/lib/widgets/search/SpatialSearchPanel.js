 ...
 *  like the `Ostim.widgets.search.SearchByDrawPanel <SearchByDrawPanel.html>`_ and
 *  the `Ostim.widgets.search.SearchByFeaturePanel <SearchByFeaturePanel.html>`_..
 *
 */
 ...
 * instantiated, use subclasses like the `Ostim.widgets.search.SearchByDrawPanel <SearchByDrawPanel.html>`_.
 */
Ostim.widgets.search.SpatialSearchPanel = Ext.extend(Ext.Panel, {
    layout: 'form',
...
// See also: http://ian01.geog.psu.edu/geoserver_docs/apps/gaz/search.html
    initComponent: function () {
        ...
        Ostim.widgets.search.SpatialSearchPanel.superclass.initComponent.call(this);
    ...
    createStatusPanel: function () {
        ...
        this.statusPanel = new Ostim.widgets.HTMLPanel({
            html: infoText,
    ...
    createDrawToolPanel: function (config) {
        ...
        return this.drawToolPanel = new Ostim.widgets.HTMLPanel(config);
    },
...
//            anchor: '100%',
        ...
        config = Ext.apply(defaultConfig, config);
        return this.targetLayerCombo = new Ostim.widgets.LayerCombo(config);
    },
...
Ext.reg('hr_spatialsearchpanel', Ostim.widgets.search.SpatialSearchPanel);
