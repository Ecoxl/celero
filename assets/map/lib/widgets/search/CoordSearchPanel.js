 ...
 *
 *      var panel = new Ostim.widgets.search.CoordSearchPanel({
 ...
 */
Ostim.widgets.search.CoordSearchPanel = Ext.extend(Ext.form.FormPanel, {
	...
	initComponent: function () {
		...
		Ostim.widgets.search.CoordSearchPanel.superclass.initComponent.call(this);
	...
	panAndZoom: function (self) {
		...
		if(!this.arrProj.getAt(self.pCombo.value).data.iconOL) {
			var iconUrl = Ostim.Utils.getImageLocation(this.arrProj.getAt(self.pCombo.value).data.localIconFile);
...
Ext.reg("hr_coordsearchpanel", Ostim.widgets.search.CoordSearchPanel);
