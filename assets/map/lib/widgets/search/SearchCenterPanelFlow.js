...
/** api: example
 *  Sample code showing how to configure a Ostim SearchCenterPanel.
 *  Note that the  config here contains both a Ostim FormSearchPanel object (search form) and a Ostim FeaturePanel
 ...
 */
Ostim.widgets.search.SearchCenterPanelFlow = Ext.extend(Ext.Panel, {
	...
	initComponent: function () {
		...
		Ostim.widgets.search.SearchCenterPanelFlow.superclass.initComponent.call(this);
	...
	onSearchSuccess: function (searchPanel, result) {
		...
		if (!this.resultPanel) {
			...
			this.resultPanel = new Ostim.widgets.search.FeaturePanel(this.hropts.resultPanel);
...
Ext.reg('hr_searchcenterpanelflow', Ostim.widgets.search.SearchCenterPanelFlow);

/** Compatibilty with pre 0.73. renamed Ostim.widgets.FeatSelSearchPanel to Ostim.widgets.search.SearchCenterPanel */
Ext.reg('hr_featselsearchpanelflow', Ostim.widgets.search.SearchCenterPanelFlow);
