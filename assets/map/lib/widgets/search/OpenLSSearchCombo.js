 ...
 */
Ostim.widgets.search.OpenLSSearchCombo = Ext.extend(Ext.form.ComboBox, {
			...
			initComponent: function() {
				Ostim.widgets.search.OpenLSSearchCombo.superclass.initComponent.apply(this, arguments);
				this.store = new Ext.data.Store({
							...
							reader: new Ostim.data.OpenLS_XLSReader()
						});
...
Ext.reg('hr_openlssearchcombo', Ostim.widgets.search.OpenLSSearchCombo);
