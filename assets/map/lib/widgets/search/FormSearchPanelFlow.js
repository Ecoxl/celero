 ...
 */
Ostim.widgets.search.FormSearchPanelFlow = Ext.extend(GeoExt.form.FormPanel, {
...
// See also: http://ian01.geog.psu.edu/geoserver_docs/apps/gaz/search.html
    initComponent: function () {
        ...
        /**
         * zeynel dağlı
         * üst sınıftan extend ediliyor
         */
        Ostim.widgets.search.FormSearchPanelFlow.superclass.initComponent.call(this);
    ...
    search: function () {
        this.action = null;
        Ostim.widgets.search.FormSearchPanelFlow.superclass.search.call(this, {
...
Ext.reg('hr_formsearchpanelflow', Ostim.widgets.search.FormSearchPanelFlow);
...
Ext.reg('hr_searchpanelflow', Ostim.widgets.search.FormSearchPanelFlow);
