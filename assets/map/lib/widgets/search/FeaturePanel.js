 ...
 */
Ostim.widgets.search.FeaturePanel = Ext.extend(Ext.Panel, {
...
Ext.reg('hr_featurepanel', Ostim.widgets.search.FeaturePanel);

/** Old, compat with pre-1.0.1 name. */
Ext.reg('hr_featuregridpanel', Ostim.widgets.search.FeaturePanel);

/** Old, compat with pre-0.72 name. */
Ext.reg('hr_featselgridpanel', Ostim.widgets.search.FeaturePanel);