 ...
 *  base_link = `Ostim.widgets.search.SpatialSearchPanel <SpatialSearchPanel.html>`_
 */

/** api: example
 *  This Panel is mostly used in combination with the  `Ostim.widgets.search.FeaturePanel <FeaturePanel.html>`_
 ...
 *  as below. ``Ostim.examples.searchPanelConfig`` is the ``SearchCenterPanel`` config as above.
 *
 *  .. code-block:: javascript
    ...
    options: {
        ...
        searchWindow: {
            ...
            height: 400,
            items: [
                Ostim.examples.searchPanelConfig
            ]
        }
    }
    }
 ...
 *
 */
Ostim.widgets.search.SearchByFeaturePanel = Ext.extend(Ostim.widgets.search.SpatialSearchPanel, {
...
// See also: http://ian01.geog.psu.edu/geoserver_docs/apps/gaz/search.html
    initComponent: function () {
        ...
        Ostim.widgets.search.SearchByFeaturePanel.superclass.initComponent.call(this);
    },
    ...
    createDrawFieldSet: function () {
        ...
        this.selectionStatusField = new Ostim.widgets.HTMLPanel({
...
//            anchor: "100%",
    ...
    createSourceLayerCombo: function () {
        return this.sourceLayerCombo = new Ostim.widgets.LayerCombo(
                {
//                     anchor: "100%",
...
//        this.updateStatusPanel(__('Press the Search button to start your Search.'));
    ...
    onSearchCanceled: function (searchPanel) {
        Ostim.widgets.search.SearchByFeaturePanel.superclass.onSearchCanceled.call(this);
        this.resetForm();
    },
    ...
    onSearchSuccess: function (searchPanel, result) {
        ...
        if (this.searchSelect) {
            ...
            Ostim.widgets.search.SearchByFeaturePanel.superclass.onSearchSuccess.call(this, searchPanel, result);
        }
    },
...
Ext.reg('hr_searchbyfeaturepanel', Ostim.widgets.search.SearchByFeaturePanel);
