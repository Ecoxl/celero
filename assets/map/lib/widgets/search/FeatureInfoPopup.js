 ...
 *
 */
Ostim.widgets.search.FeatureInfoPopup = Ext.extend(GeoExt.Popup, {
    ...
    initComponent: function () {
        ...
        console.warn('FeatureInfopopUp initcomponent');
        ...
        // Superclass init
        Ostim.widgets.search.FeatureInfoPopup.superclass.initComponent.call(this);
    },
    ...
    createFeatureInfoPanel: function () {
        ...
        return new Ostim.widgets.search.FeatureInfoPanel(config);
    },
...
Ext.reg('hr_featureinfopopup', Ostim.widgets.search.FeatureInfoPopup);
