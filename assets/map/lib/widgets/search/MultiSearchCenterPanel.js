...
/** api: example
 *  Sample code showing how to configure a Ostim MultiSearchCenterPanel.
 ...
 */
Ostim.widgets.search.MultiSearchCenterPanel = Ext.extend(Ostim.widgets.search.SearchCenterPanel, {
    ...
    initComponent: function () {
        ...
        Ostim.widgets.search.MultiSearchCenterPanel.superclass.initComponent.call(this);
    },
    ...
    onSearchSuccess: function (searchPanel, result) {
        Ostim.widgets.search.MultiSearchCenterPanel.superclass.onSearchSuccess.call(this, searchPanel, result);
...
Ext.reg('hr_multisearchcenterpanel', Ostim.widgets.search.MultiSearchCenterPanel);
