 ...
 */
Ext.namespace("Ostim.widgets.LayerNodeMenuItem");
 ...
 */
Ostim.widgets.LayerNodeMenuItem = Ext.extend(Ext.menu.Item, {
    ...
    /*
    listeners :  {
        'afterrender': function (menuItem, event) {
            alert('afterrender event'); 
            alert(this);
        },
        'beforehide': function (menuItem, event) {
            //alert('beforehide event');                              
        },
        'hide': function (menuItem, event) {
            //alert('hide event');                              
        },
        scope: this
    }
 ...
 */
Ostim.widgets.LayerNodeMenuItem.Style = Ext.extend(Ostim.widgets.LayerNodeMenuItem, {
    ...
    initComponent: function () {
        Ostim.widgets.LayerNodeMenuItem.Style.superclass.initComponent.call(this);
    },
    ...
    handler: function (menuItem, event) {
        ...
        var layerRecord = Ostim.App.getMapPanel().layers.getByLayer(node.layer);
...
Ext.reg('hr_layernodemenustyle', Ostim.widgets.LayerNodeMenuItem.Style);
 ...
 *
 */
Ostim.widgets.LayerNodeMenuItem.ZoomExtent = Ext.extend(Ostim.widgets.LayerNodeMenuItem, {

    text: __('Zoom to Layer Extent'),
    iconCls: "icon-zoom-visible",

    initComponent: function () {
        Ostim.widgets.LayerNodeMenuItem.ZoomExtent.superclass.initComponent.call(this);
    },
...
Ext.reg('hr_layernodemenuzoomextent', Ostim.widgets.LayerNodeMenuItem.ZoomExtent);
 ...
 */
Ostim.widgets.LayerNodeMenuItem.LayerInfo = Ext.extend(Ostim.widgets.LayerNodeMenuItem, {
    ...
    */
    initComponent: function () {
        Ostim.widgets.LayerNodeMenuItem.LayerInfo.superclass.initComponent.call(this);
    },
...
Ext.reg('hr_layernodemenulayerinfo', Ostim.widgets.LayerNodeMenuItem.LayerInfo);
 ...
 */
Ostim.widgets.LayerNodeMenuItem.OpacitySlider = Ext.extend(Ostim.widgets.LayerNodeMenuItem, {

    text: __('Change Layer opacity'),
    iconCls: 'icon-opacity',

    initComponent: function () {
        Ostim.widgets.LayerNodeMenuItem.OpacitySlider.superclass.initComponent.call(this);
    },
...
Ext.reg('hr_layernodemenuopacityslider', Ostim.widgets.LayerNodeMenuItem.OpacitySlider);
