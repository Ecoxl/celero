...
Ostim.Utils =
        (function () { // Creates and runs anonymous function, its result is assigned to Singleton
            ...
            var instance = {
                 ...
                 *
                 * Returns:
                 * {String} The URL string for the directory where of the Ostim main script
                 */
                getScriptLocation: function () {
                    if (!Ostim.globals.scriptLoc) {
                        Ostim.globals.scriptLoc = '';
                        var scriptName = (!Ostim.singleFile) ? "lib/DynLoader.js" : "script/Ostim.js";
                        ...
                        for (var i = 0, len = scripts.length; i < len; i++) {
                            ...
                            if (src) {
                                var m = src.match(r);
                                if (m) {
                                    Ostim.globals.scriptLoc = m[1];
                                    break;
                                }
                            }
                        }
                    }
                    return Ostim.globals.scriptLoc;
                },
                ...
                getImagesLocation: function () {
                    return Ostim.globals.imagePath || (Ostim.Utils.getScriptLocation() + "resources/images/");
                },
                ...
                getImageLocation: function (image) {
                    return Ostim.Utils.getImagesLocation() + image;
                },
                ...
                randArrayElm: function (arr) {
                    return arr[Ostim.Utils.rand(0, arr.length - 1)];
                },
