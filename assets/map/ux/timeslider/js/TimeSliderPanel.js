...
/** api: constructor
 *  .. class:: Ostim.widgets.TimeSliderPanel(config)
 *
 *  A panel designed to hold HTML content.
 */
Ostim.widgets.TimeSliderPanel = Ext.extend(Ext.Panel, {
    ...
    initComponent: function () {
        ...
        Ostim.widgets.TimeSliderPanel.superclass.initComponent.call(this);
...
Ext.reg('hr_timesliderpanel', Ostim.widgets.TimeSliderPanel);
