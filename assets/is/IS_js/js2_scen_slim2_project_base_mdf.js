             ...
             $.ajax({
                 ...
                 success: function(data, textStatus, jqXHR) {
                     ...
                     $('#tt_grid2').datagrid({
                         ...
                         url: '../../../Proxy/SlimProxy.php',
                         queryParams: {
                             url: 'companies_json_test2_manual',
                             prj_id: $('#prj_id').val()
                         },
                         method: 'get',
                         idField: 'id',
                     ...
                     dg.datagrid('enableFilter', arrayFilter);
                 },
                 error: function(jqXHR, textStatus, errorThrown) {
                     console.warn('error text status-->' + textStatus);
                 }
     ...
     $.messager.confirm('Confirm', 'Are you sure ? New Table with new data will be deployed...', function(r) {
         if (r) {
             ...
             $.each(nodes, function(index, obj) {
                 if (obj.attributes.notroot == false) {} else if (obj.attributes.notroot == true) {
 ...
 function addRow() {
     if ($('#tt_grid_dynamic2').datagrid('getSelections').length == 1 && $('#tt_grid_dynamic3').datagrid('getSelections').length == 1 && $('#tt_grid2').datagrid('getSelections').length == 1) {
         $('#tt_grid_dynamic4').datagrid('appendRow', {
             id: '' + $('#tt_grid2').datagrid('getSelections')[0].id + ',' + $('#tt_grid_dynamic3').datagrid('getSelections')[0].id + ',' + $('#tt_grid_dynamic2').datagrid('getSelections')[0].id + ',' + $('#tt_grid_dynamic3').datagrid('getSelections')[0].flowID + ',' + $('#tt_grid_dynamic3').datagrid('getSelections')[0].unit_id + ',' + $('#tt_grid_dynamic3').datagrid('getSelections')[0].flow_type_id + '',
             ...
             /*flowtype:'floww type',*/
             map: '' + $('#tt_grid2').datagrid('getSelections')[0].id + ',' + $('#tt_grid_dynamic3').datagrid('getSelections')[0].id + '',
         });
         $('#tt_grid_dynamic3').datagrid('clearChecked');
     } else {
         $.messager.alert('Pick rows', 'Please select at least one IS Potential', 'warning');
     }
 }
 ...
 function getFlowCompanies(index, flowName, companyID) {
     ...
     $('#tt_grid_dynamic3').datagrid('getPanel').panel("setTitle", "Step 3: Match '"+flowName+"' with a flow from the list below");
 ...
 function beginISPotential() {
     ...
     if ($('#tt_grid2').datagrid('getSelections').length == 1) {
         $('#startbutton').attr("href", "#specificFlow");
         ...
         $('#startbutton').attr("href", "#");
         $('#tt_grid_dynamic2').datagrid('reload');
         $.messager.alert('Only one company at a time', 'Please select only one company!', 'warning');
     } else {
         $('#startbutton').attr("href", "#");
         $('#tt_grid_dynamic2').datagrid('reload');
         $.messager.alert('Pick a company', 'Please select a company!', 'warning');
     }
 ...
 $(function() {
             ...
             ddv.datagrid({
                 ...
                 columns: [
                     [{
                         ...
                         field: 'potential_energy_unit',
                         title: 'Potential Energy Unit',
                         width: 100
                     }, {
                         field: 'supply_cost',
                         title: 'Supply Cost',
                         ...
                         field: 'supply_cost_unit',
                         title: 'Supply Cost Unit',
                         width: 100
                     }, {
                         field: 'transport_id',
                         title: 'Transport',
                         ...
                         field: 'min_flow_rate_unit',
                         title: 'Min Flow Rate Unit',
                         width: 100
                     }, {
                         field: 'max_flow_rate',
                         title: 'Max Flow Rate',
                         ...
                         field: 'max_flow_rate_unit',
                         title: 'Max Flow Rate Unit',
                         width: 100
                     }, {
                         field: 'substitute_potential',
     ...
     $('#tt_grid2').datagrid({
         url: '../../../Proxy/SlimProxy.php',
         queryParams: {
             url: 'flowsAndCompanies_json_test_MDF_manual',
             //flows : JSON.stringify(arrayLeaf),
             prj_id: $('#prj_id').val()
         }
     });
